    ...
    <div v-if="movieDetail && movieCast && movieImages" class="mb-5">
        ...
        <div class="flex pt-5 px-10 justify-between items-center">
            <div class="flex">
                ...
                <h1 class="text-4xl overflow-hidden self-end gris py-2">({{movieDetail.release_date.slice(0,4)}})</h1>
            </div>
            <router-link to="/"> 
        ...
        <div class="flex flex-row pl-10 mt-5">
            ...
            <div class="flex flex-col w-full space-y-10">
                ...
                <!-- MORE IMAGES -->
                <div class="flex more-images space-x-4 justify-around mx-5 p-3">
                    <div v-for="(image, Index) in movieImages.backdrops.slice(0,4)" :key="Index">
                        <a :href="'https://image.tmdb.org/t/p/w500'+image.file_path" target="blank">
                            <img :src="'https://image.tmdb.org/t/p/w500/'+image.file_path" alt="Backdrop" class="w-56 backdrops">
                        </a>
                    </div>
                </div>
            </div>
